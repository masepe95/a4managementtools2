...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <script type="text/javascript" src="build/js/inputs.js"></script>
            ...
            (function($) {
                $(function(){
                    $("select#language").on("change", function(evt) {
                        var locale = $(this).val();
                        window.location.href = "{{ route('changeLanguage') }}?locale=" + locale;
                    });
                });
            })(jQuery);
        </script>
    ...
    <body class="antialiased">
        ...
        @if (Route::has('login'))
            ...
            @endauth
                ...
                <select id="language" name="language" data-te-select-init="">
                @foreach ($languages as $language)
                    <option value="{{ $language->code }}"{{ ($language->code == $currentLanguage) ? ' selected=""' : ''}}>{{ $language->name }}</option>
                @endforeach
                </select>
                <label data-te-select-label-ref="">Language</label>
            </div>
        @endif
